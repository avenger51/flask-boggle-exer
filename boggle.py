...
class Boggle():
    ...
    def __init__(self):
        #self.words reads and stores into self.words
        self.words = self.read_dict("words.txt")
        
    def read_dict(self, dict_path):
        """Read and return all words in dictionary."""
        #opens file, reads line by line, strips whitespace 
    ...
    def make_board(self):
        ...
        #creates a 5x5 grid of uppercase letters using random.choice
        #function and the string.ascii_uppercase const
        board = []
    ...
    def check_valid_word(self, board, word):
        ...
        #takes boggle board ('board') and a word ('word') as input
        #checks if 'word' exists in 'self.words' (dict of valid words)
            #and if it can be formed on the board using 'find' method
